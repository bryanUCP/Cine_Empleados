...
public class EliminarEmpleadoResponse {
    ...
    protected List<EliminarEmpleadoResponse.Empleado> empleado;
     ...
     * {@link EliminarEmpleadoResponse.Empleado }
     * 
     * 
     */
    public List<EliminarEmpleadoResponse.Empleado> getEmpleado() {
        if (empleado == null) {
            empleado = new ArrayList<EliminarEmpleadoResponse.Empleado>();
        }
